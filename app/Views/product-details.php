        ...
        <div class="product-container">
            <div class="left-side">
                <div class="product-image">
                    <div class="image">
                        <img src="<?= base_url('assets/images/product-images/' . esc($product['productImage'])) ?>" alt="Product Image">
                    </div>
                </div>
            </div>
            ...
            <div class="right-side">
                <div class="product-details">
                    <span class="status"><?= ((int) $product['productStock'] > 0) ? 'Available' : 'Out of Stock' ?></span>
                    <h1 class="product-name"><?= esc($product['productName']) ?></h1>
                    <p class="product-price">
                        ₱<?= number_format((float) $product['productPrice'], 2) ?>
                ...
                <div class="product-info">
                    ...
                    <details>
                        ...
                        <p>Learn more about shipping and delivery upon checking out the products!</p>
                    </details>
                </div>
            </div>
        </div>
